...
import com.test.counter.CounterMapper.InfoCounter;
...
public class CounterDriver extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    if (success) {
       ...
       */
      long email = job.getCounters().findCounter(InfoCounter.EMAIL).getValue();
      long mobile = job.getCounters().findCounter(InfoCounter.MOBILE).getValue();
